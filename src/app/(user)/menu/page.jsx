                ...
                return (
                  ...
                  >
                    <div className="relative h-48 w-full overflow-hidden">
                      ...
                      />
                      {/* Rating Badge */}
                      <div className="absolute top-3 right-3 bg-black/60 backdrop-blur-sm text-primary-gold px-2 py-1 rounded-md text-xs font-bold border border-white/10">
                        ⭐ {food.stars || 4.5}
                      </div>
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <button className="w-full mt-4 py-2 rounded-xl border border-white/20 text-sm font-medium text-gray-300 hover:bg-white/10 hover:text-white transition-all">
                        View Food
                      </button>
                    </div>
                  </motion.div>
